...
import type { ActiveStudentsEvolutionRow } from "@/features/dashboard/types";
import { useChartColors } from "@/hooks/use-chart-colors";

type ActiveStudentsEvolutionChartProps = {
  data: ActiveStudentsEvolutionRow[];
  emptyMessage?: string;
};

export function ActiveStudentsEvolutionChart({
  data,
  emptyMessage = "Sin datos",
}: ActiveStudentsEvolutionChartProps) {
    ...
    <ResponsiveContainer width="100%" height={280}>
      <LineChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
        ...
        <Tooltip
          ...
          formatter={(value: number) => [value, "Alumnos activos"]}
        />
        <Line
          type="monotone"
