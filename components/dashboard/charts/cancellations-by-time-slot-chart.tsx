...
type CancellationsByTimeSlotChartProps = {
  data: TimeSlotCount[];
  emptyMessage?: string;
};

export function CancellationsByTimeSlotChart({
  data,
  emptyMessage = "Sin datos",
}: CancellationsByTimeSlotChartProps) {
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      ...
      >
        ...
        />
        <Bar dataKey="count" name="Cancelaciones" fill={CANCELLATION_FILL} radius={[0, 4, 4, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
