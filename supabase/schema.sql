...
CREATE INDEX IF NOT EXISTS idx_classes_teacher_scope_date ON public.classes (teacher_id, scope, class_date);
...
-- =============================================================================
-- 026/027: Ranking de alumnos (Bloque 7 del Dashboard Ejecutivo)
-- =============================================================================
